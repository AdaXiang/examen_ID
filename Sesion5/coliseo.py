#matchTemplate(imagen, plantilla, método) buscar ubicación imagen

#minMaxLoc(imagen): dónde mayor coincidencia y posición

#no puede estar girada
...
img = cv2.imread('./coliseo.jpg')
patron = cv2.imread('./coliseo_recorte.jpg')
