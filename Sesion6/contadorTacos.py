...
posicion_texto_6 = (20, 30)

posicion_texto_8 = (20, 60)

posicion_texto_10 = (20, 90)
...
num_tacos_6 = num_tacos_8 = num_tacos_10 = 0
    ...
    for contorno in contornos:
        ...
        if area <= area_max:
            ...
            if area >= area_min_10:
                ...
                cv2.putText(frame, "10", centro_objeto, fuente, escala, color, grosor)

            elif area >= area_min_8:

                num_tacos_8 += 1

                cv2.putText(frame, "8", centro_objeto, fuente, escala, color, grosor)

            elif area >= area_min_6:

                num_tacos_6 += 1

                cv2.putText(frame, "6", centro_objeto, fuente, escala, color, grosor)



    #print("---")

    cv2.putText(frame, "Tacos del numero  6: " + str(num_tacos_6), posicion_texto_6, fuente, escala, color, grosor)

    cv2.putText(frame, "Tacos del numero  8: " + str(num_tacos_8), posicion_texto_8, fuente, escala, color, grosor)

    cv2.putText(frame, "Tacos del numero 10: " + str(num_tacos_10), posicion_texto_10, fuente, escala, color, grosor)
