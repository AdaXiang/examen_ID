#PointPolygonTest(contorno, punto, tipo)

#Posición de un pto respecto de un contorno

#matchShapes(contorno1, contorno2, método, parámetro)
...
img = cv2.imread('./numeros.jpg', 0)

img1 = cv2.imread('./uno.jpg',0)
img2 = cv2.imread('./dos.jpg',0)
img3 = cv2.imread('./tres.jpg',0)
